...
class NewDrop extends Component {
    ...
    render() {
        ...
        return(
            <>
                <h1 className="templatecreate">Create a Drop</h1>
                <div className="templateoptions">
                    
                    <h2 className="ntname"> Drop Name: </h2>
                    <input type = "nttext" value={this.state.name} onChange={event => this.setState({name:event.target.value})} ></input>
                    <h2 className="ntcreator">Location: </h2>
                    <input type = "text" value={this.state.drop_location} onChange={event=> this.setState({drop_location:event.target.value})}></input>
                </div>
